...
class MLPredictionApp:
    ...
    def setup_ui(self):
        ...
        self.notebook.add(self.tab_charts, text=" Prediction & Feature Importance Charts ")
    ...
    def load_model(self):
        ...
        try:
            ...
            # Check if the object has a prediction method
    ...
    def validate_csv_against_model(self, temp_df):
        ...
        # Reject if more than 50% of expected features are entirely missing from input
    ...
    def upload_csv(self):
        ...
        try:
            ...
            # Update target column dropdown options
            cols = ["-- Auto Detect --"] + list(self.df.columns)
            self.combo_target["values"] = cols
            
            # Auto select target column if 'Attrition' exists
    ...
    def preprocess_features(self, df_input):
        ...
        # Exclude selected target attribute from features if present
        ...
        # Align features with model expected attributes
    ...
    def run_prediction(self):
        ...
        try:
            ...
            # Safely invoke prediction method on model object
            ...
            # Map to user-friendly risk levels
            friendly_preds = []
            for p in raw_preds:
    ...
    def render_charts(self):
        ...
        # Plot 1: Prediction Risk Distribution
        ...
        ax1.set_title("Attrition Risk Breakdown")
        ax1.set_xlabel("Risk Level")
        ax1.set_ylabel("Employee Count")
        ax1.tick_params(axis="x", rotation=15)

        # Plot 2: Feature Importance Attributes
        ...
        if hasattr(self.model, "feature_importances_") and hasattr(self.model, "feature_names_in_"):
            ...
            ax2.set_title("Top Important Factors")
            ...
            ax2.set_title("Important Factors")
